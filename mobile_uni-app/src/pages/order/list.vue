<template>
  <view class="order">
    ...
    <scroll-view
      scroll-x
      class="bg-white solid-bottom nav"
      ...
      >
        <view class="cu-bar">
          ...
          <view
            ...
            :class="ORDER_STATUS_CLASS[item.status]"
          >
        ...
        <view class="flex padding">
          <view class="flex-sub text-right">
            <button
              v-if="item.status === 'initial'"
              @tap.stop="cancelBill(index)"
            ...
            <button
              v-else
              @tap.stop="beforeOrderAgain(item.uuid)"
              class="cu-btn round text-black line-black margin-left-sm"
            >再次购买
            </button>
            <button
              v-if="item.status === 'dispatching'"
              @tap.stop="completeBill(index)"
              class="cu-btn round text-red line-red margin-left-sm"
            >确认收货
            </button>
          </view>
